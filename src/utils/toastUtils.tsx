...
// Constants and utilities for Toast component
export const getToastStyles = (type: ToastType): string => {
  const baseStyles = 'mb-4 p-4 rounded-lg shadow-lg border-l-4 transition-all duration-300 transform translate-x-0 opacity-100';
...
export const getIcon = (type: ToastType): React.ReactNode => {
  switch (type) {
    case 'success':
      return (
