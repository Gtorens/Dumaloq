            ...
            floors: [
                 {
                    ...
                    description: 'Первый этаж площадью 800 кв.м полностью занят якорным арендатором — крупнейший в стране супермаркет Korzinka. Максимальный трафик и стабильный поток посетителей с первого дня.',
                    logos: [
        ...
        floorPlans: {
            ...
            tabs: {
                floor1: {
                    ...
                    conceptText: "Этаж с максимальным трафиком площадью 800 кв.м. Полностью занят якорным арендатором Korzinka, обеспечивая стабильный поток посетителей и высокую проходимость.",
            ...
            floors: [
                {
                    ...
                    description: 'The first floor with an area of 800 m² is fully occupied by the anchor tenant — the country\'s largest supermarket Korzinka. Maximum traffic and a stable flow of visitors from day one.',
                    logos: [
                        { url: "/logo/korzinka.png", name: "Korzinka" }
                    ],
                    imageUrl: '/images/floor-plans/floor-1.jpg'
        ...
        floorPlans: {
            ...
            tabs: {
                floor1: {
                    ...
                    conceptText: "An 800 m² floor fully occupied by the anchor tenant Korzinka, ensuring a stable flow of visitors and high foot traffic.",
            ...
            floors: [
                {
                    ...
                    description: '800 m² maydonga ega birinchi qavat to‘liq yakor ijarachi — mamlakatdagi eng yirik Korzinka supermarketi tomonidan egallangan. Birinchi kundan boshlab maksimal trafik va barqaror tashrif buyuruvchilar oqimi.',
                    logos: [
                        { url: "/logo/korzinka.png", name: "Korzinka" }
                    ],
                    imageUrl: '/images/floor-plans/floor-1.jpg'
        ...
        floorPlans: {
            ...
            tabs: {
                floor1: {
                    ...
                    conceptText: "800 m² maydon — Korzinka kabi yakor ijarachi tomonidan to‘liq egallangan, bu barqaror tashrif buyuruvchilar oqimi va yuqori o‘tuvchanlikni taʼminlaydi.",
