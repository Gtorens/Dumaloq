...
// Mock window для десктопного окружения
...
describe('Button Component', () => {
  ...
  it('applies size classes correctly', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('px-3', 'py-1.5', 'text-sm'); // desktop sizes

    rerender(<Button size="lg">Кнопка</Button>);
    expect(screen.getByRole('button')).toHaveClass('px-6', 'py-3', 'text-base'); // desktop sizes
  });
